  ...
  <header class="w-full">
    ...
    <div class="top-bar hidden md:flex">
      <div class="container mx-auto px-4 top-bar-container relative">
        <div class="right-part" style="margin-left: 180px;">
          <!-- Stores -->
          <div class="nav-item">
        ...
        <!-- Centered Text -->
        <div class="absolute left-[50%] transform -translate-x-1/2" style="font-family: 'Roboto'; font-weight: 400; font-size: 14px; line-height: 24px; letter-spacing: 0px; text-align: center; vertical-align: middle; color: #ECECEC80;">
          Watsons Beauty and Personal Care Awards Nominees!
        </div>

        <!-- Contact Info (Right Aligned) -->
        <div class="ml-auto flex items-center space-x-2">
           <span style="font-family: 'Roboto'; font-weight: 500; font-size: 14px; line-height: 24px; letter-spacing: 0px; text-align: center; vertical-align: middle; color: #FFFFFF; margin-right: 10px;">Call us:(+90) 850 123 45 67</span>
           <div class="icon-wrapper" style="margin-right: 170px;">
    ...
    <div class="container mx-auto px-4 pt-0 pb-1 flex md:flex-nowrap justify-start items-center gap-4">
      <!-- Logo -->
      <div class="logo flex-shrink-0" style="margin-left: 161px;"> 
         <img src="~/assets/css/icon/logo.png" alt="Watsons" class="h-7 w-auto" />
      </div>

      <!-- Search Bar -->
      <div class="flex items-center w-full md:w-[560px] order-3 md:order-none mt-2 md:mt-0 ml-[150px]" style="height: 42px; background: rgba(236, 236, 236, 0.3); border-radius: 32px; padding: 0px 8px; gap: 8px;">
        <!-- Icon (Order 0) -->
      ...
      <!-- User & Cart Section -->
      <div class="flex items-center ml-auto" style="gap: 32px; margin-right: 150px;">
        ...
        <!-- Separator -->
        <div class="hidden md:block h-6 w-px" style="background-color: #ECECEC;"></div>

        <!-- Cart -->
        <div class="relative cursor-pointer flex items-end justify-center" style="width: 25px; height: 72px; padding-bottom: 10px; margin-top: 12px;">
    ...
    <div class="hidden md:block">
      <div class="container mx-auto px-4 pr-[105px] pl-[180px]">
        <nav class="flex overflow-x-auto whitespace-nowrap items-center w-full" style="gap: 40px;">
           ...
           <a href="#" class="nav-menu-item">BRANDS</a>
        </nav>
      </div>
    </div>
